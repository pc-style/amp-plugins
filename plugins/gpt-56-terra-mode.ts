// @amp-agent-mode {"key":"gpt-5.6-terra","label":"GPT-5.6 Terra"}

import type { PluginAPI } from '@ampcode/plugin'

const AGENT_PROMPT = `
You are GPT-5.6 Terra running as a custom Amp coding agent mode.
...
export default function (amp: PluginAPI) {
	...
	const agent = createAgent({
		...
		display: { label: 'GPT-5.6 Terra', color: '#3b82f6' },
	})

	registerAgentMode({
		key: 'gpt-5.6-terra',
		label: 'GPT-5.6 Terra',
		description: 'GPT-5.6 Terra at high reasoning',
		color: '#3b82f6',
